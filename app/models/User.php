...
class User extends \HXPHP\System\Model
{
	...
	static $validates_uniqueness_of = array(
			array(
				'username', 
				'message' => 'Já existe um usário com este nome de usário cadastrado.'
			),
			array(
				'email', 
				'message' => 'Já existe um usário com este e-mail cadastrado.'
			)
		);
	...
	public static function atualizar($user_id, array $post)
	{
		...
		{	
			array_push($callbackObj->errors, 'Já existe um usuário com esse e-mail cadastrado. Por favor tentar novamente com outro e-mail.');
			return $callbackObj;
		}
		...
		{	
			array_push($callbackObj->errors, 'Já existe um usuário com este login. Por favor tentar novamente com outro e-mail.');
			return $callbackObj;
		}
